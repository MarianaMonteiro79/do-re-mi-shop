...
<body>
    ...
    <main>
        ...
        <section class="cart">
            ...
            <% } else { %>
                ...
                <form action="confirmarCompra.jsp" method="post" onsubmit="return validarCompra();">
				    <div class="cart__options">
				        <div class="cart__shipping">
				            <h2>Envio</h2>
				            <label>
				                <input type="radio" name="endereco" value="Entrega ao domicílio" required>
				                Entrega ao domicílio
				            </label>
				            <label>
				                <input type="radio" name="endereco" value="Levantamento em loja">
				        ...
				        <div class="cart__payment">
				            ...
				            <label>
				                <input type="radio" name="metodoPagamento" value="MB WAY" required>
				                MB WAY
				            </label>
				            <label>
				                <input type="radio" name="metodoPagamento" value="Multibanco">
				                Multibanco
				            </label>
				            <label>
				                <input type="radio" name="metodoPagamento" value="Cartão de Crédito">
				                Cartão de Crédito
				            </label>
				        </div>
				        ...
				        <div class="cart__info">
				            <h2>Contacto</h2>
				            <input type="text" name="contacto" pattern="[0-9]{9}" required placeholder="Ex: 912345678">
				        </div>
				    </div>
				
				    <div class="cart__actions">
				        <button class="cart__comment" type="button">
				            <a href="comentar.jsp" style="text-decoration: none; color: black;">Comentar</a>
				        </button>
				        <button class="cart__confirm" type="submit">Confirmar Compra</button>
				    </div>
				</form>
            <% } %>
        </section>
    ...
    <script>
        ...
        function validarCompra() {
            ...
            const endereco = document.querySelector('input[name="endereco"]:checked');
            const contacto = document.querySelector('input[name="contacto"]').value;

            if (!metodo || !endereco || !contacto.match(/^[0-9]{9}$/)) {
